...
<template>
  <NuxtLayout name="starry" footer="simply">
    ...
    <div
      class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 w-[90%] mx-auto mt-8 mb-16"
    >
      <div
        v-for="branch in branches"
        class="rounded overflow-hidden text-white group"
      >
        <div class="aspect-video overflow-hidden">
          <img
            :src="branch.coverPhoto"
            class="object-contain group-hover:scale-110 transition-all"
            loading="lazy"
          />
        </div>
